...
SECRET_KEY = 'django-insecure-+3)-x&ux3ddq2dm2h8d&&15p5!)%e!k*hw!3almbmwtf_n!w-i'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'bloglite'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Blog Lite API',
    'DESCRIPTION': 'A simple blog API with posts, subposts, likes, and views',
    'VERSION': '1.0.0',
}